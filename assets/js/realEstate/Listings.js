...
export default class Header extends Component {
  ...
  loopListings() {
    ...
    return pageOfItems.map((listing, index) => {
      ...
      <section id="listings">
        ...
        <section className="sortby-area">
          ...
          <div className="sort-options">
            ...
            <div className="view">
              <i className="fa fa-th-list" aria-hidden="true" onClick={this.props.changeView.bind(null, 'list')}></i>
              <i className="fa fa-th" aria-hidden="true" onClick={this.props.changeView.bind(null, 'gallery')}></i>
            </div>
          </div>
        </section>
